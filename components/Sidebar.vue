    ...
    >
      ...
      >
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
          ...
          <li class="items-center">
            <a class="text-gray-800 hover:text-gray-600 text-xs uppercase py-3 font-bold block" href="#/login">
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
          <li class="inline-flex">
            <button class="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold" @click="toggleModal()">
              <i class="fas fa-paint-brush mr-2 text-gray-500 text-base"></i>
              データ追加
            </button>
          </li>
          <li class="inline-flex">
            <a class="text-gray-800 hover:text-gray-600  text-sm block mb-4 no-underline font-semibold" href="#/documentation/angular/alerts">
              <i class="fab fa-angular mr-2 text-gray-500 text-base"></i>
              Angular
            </a>
          </li>
          <li class="inline-flex">
            <a class="text-gray-800 hover:text-gray-600  text-sm block mb-4 no-underline font-semibold" href="#/documentation/javascript/alerts">
