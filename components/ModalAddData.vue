              ...
              <v-col cols="12" sm="6" md="6">
                <v-slider v-model="urgencyLevel" label="緊急度" class="align-center" min=0 max=100 step="10" hide-details>
                  <template v-slot:append>
                    <v-text-field v-model="urgencyLevel" hide-details single-line type="number" style="width: 45px"/>
                  </template>
                </v-slider>
              </v-col>
              <v-col cols="12" sm="6" md="6">
                <v-slider v-model="difficultyLevel" label="実現難易度" class="align-center" min=0 max=100 step="10" hide-details>
                  <template v-slot:append>
                    <v-text-field v-model="difficultyLevel" hide-details single-line type="number" style="width: 45px"/>
                  </template>
                </v-slider>
              </v-col>
            </v-row>
